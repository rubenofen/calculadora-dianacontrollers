...
export const BUSINESS_INDIRECT_FIELDS = [
  {
    id: "nominas",
    label: "Nóminas y personal fijo (desde Equipo)",
    unit: "€/mes",
  },
  ...
  {
    id: "autonomos",
    label: "Cuota autónomos / costes societarios",
    unit: "€/mes",
  },
  ...
  {
    id: "formacion",
    label: "Formación y desarrollo profesional",
    unit: "€/mes",
  },
  {
    id: "herramientasGestion",
    label: "Herramientas de gestión",
    unit: "€/mes",
  },
  {
    id: "horasFacturablesTotales",
    label: "Horas facturables totales/mes (desde Equipo)",
    unit: "h/mes",
  },
];
